...
Soundboardify is intended for private LAN use. It does not provide public Internet hosting, account management, or end-to-end encryption. Tailscale support is optional and disabled by default. Pairing protection should be enabled when other people or devices can reach the local network.
